...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-dir", type=Path, default=Path("data/processed/mobilerec"))
    parser.add_argument("--output-dir", type=Path, default=Path("data/outputs/sasrec-baseline"))
